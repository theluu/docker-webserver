...
<div class="max-w-5xl mx-auto mt-6">
  ...
  <div class="bg-white border-x border-b border-gray-300 rounded-b-lg">
    ...
    <div id="live" class="tab-content active">
        ...
        <div class="px-5 py-4 hover:bg-gray-50 border-b border-dashed">
          <div class="flex items-center">
            ...
            <div class="w-20 text-right text-xs">
              <div class="text-gray-500">HT 1-0</div>
              <div class="text-orange-600">+1.0</div>
            </div>
          </div>
        </div>
        <!-- Nghỉ giữa hiệp: GIỮ NGUYÊN TĨNH -->
      ...
      <!-- Các trận còn lại, mẫu giữ nguyên HTML tĩnh if muốn, copy nhiều lần nếu trình diễn cần -->
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  tabs.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (id === 'live') redBorder.style.transform = 'translateX(100%)';
      else if (id === 'all') redBorder.style.transform = 'translateX(0)';
      else if (id === 'finished') redBorder.style.transform = 'translateX(200%)';
      else if (id === 'schedule') redBorder.style.transform = 'translateX(300%)';
    });
  });
